    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("b413cfc0-f53a-4765-9430-3912efcd79cb"), "1", new DateTime(2020, 1, 18, 2, 55, 38, 806, DateTimeKind.Local).AddTicks(385), new Guid("7f430a38-a6b2-4a8f-96d5-801725dfdfc1"), 111 });

            migrationBuilder.InsertData(
                table: "AirPlane",
                columns: new[] { "Id", "Code", "CreationDate", "ModelId", "NumberOfPassengers" },
                values: new object[] { new Guid("a714554f-f363-42f1-b41a-81ee85186622"), "3B", new DateTime(2020, 1, 18, 2, 55, 38, 812, DateTimeKind.Local).AddTicks(5990), new Guid("7f430a38-a6b2-4a8f-96d5-801725dfdfc3"), 167 });

            migrationBuilder.InsertData(
                table: "AirPlane",
                columns: new[] { "Id", "Code", "CreationDate", "ModelId", "NumberOfPassengers" },
                values: new object[] { new Guid("a714554f-f363-42f1-b41a-81ee85186661"), "4", new DateTime(2020, 1, 18, 2, 55, 38, 812, DateTimeKind.Local).AddTicks(6105), new Guid("7f430a38-a6b2-4a8f-96d5-801725dfdfc4"), 117 });
